...
import doctor1 from '../assets/img (1).png';
import doctor2 from '../assets/img (2).png';
import doctor3 from '../assets/img (3).png';
import doctor4 from '../assets/img (4).png';
...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Access your complete medical history and test results anytime, anywhere.',
    ...
    },
    {
      ...
      description: 'Get digital prescriptions and track your medications with ease.',
      color: 'from-blue-500 to-blue-600',
      bgColor: 'bg-blue-50',
    },
    {
      ...
      description: 'Track your health metrics and receive insights from your healthcare team.',
      color: 'from-purple-500 to-purple-600',
      bgColor: 'bg-purple-50',
    },
    {
      ...
      description: 'Communicate directly with your doctor through our encrypted messaging system.',
      color: 'from-green-500 to-green-600',
      bgColor: 'bg-green-50',
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="inline-flex items-center px-4 py-2 bg-green-100 rounded-full">
                ...
                <span className="text-green-700 text-sm font-medium">✨ Trusted by 10,000+ patients</span>
              </div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Connect with healthcare providers who truly understand you. Get personalized 
                doctor recommendations based on your needs, preferences, and communication style.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience healthcare the way it should be - personalized, accessible, and human-centered.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-[#E8F4F8] rounded-2xl  p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-[#2952a1]/30 group"
              >
                ...
                <button className="text-[#2952a1] font-semibold hover:text-[#1e3d7a] flex items-center gap-2 group-hover:gap-3 transition-all">
                  Learn More
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {doctors.map((doctor, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button
                    onClick={() => router.push('/search-doctors')}
                    className="w-full px-4 py-3 bg-[#2952a1] text-white rounded-xl font-semibold hover:bg-[#1e3d7a] transition-colors"
                  >
                    View Profile
                  </button>
                </div>
          ...
          <div className="text-center mt-12">
            <button
              onClick={() => router.push('/search-doctors')}
              className="px-8 py-4 bg-white text-[#2952a1] border-2 border-[#2952a1] rounded-xl font-semibold hover:bg-[#ebe2cd]/30 transition-all"
            >
              View All Doctors
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#2952a1] to-[#1e3d7a] rounded-full flex items-center justify-center text-white font-bold">
