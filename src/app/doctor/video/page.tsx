...
export default function DoctorVideo() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_API || 'http://localhost:5000'}/api/doctor/my-intro-video`, {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Upload a 1-minute video introducing yourself to patients</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 space-y-8">
          ...
          {currentVideo && !previewUrl && (
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Current Video</h2>
          ...
          {previewUrl && (
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Preview New Video</h2>
              <div className="bg-gray-100 rounded-2xl overflow-hidden">
                <video
                  src={previewUrl}
                  controls
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-2xl p-12 text-center hover:border-blue-500 transition-colors">
              <div className="mb-6">
                ...
                <p className="text-gray-600 mb-4">
                  Upload a video introducing yourself (max 50MB, recommended 1 minute)
                </p>
              </div>
            ...
            <div className="mt-6 p-6 bg-purple-50 rounded-2xl border border-purple-200">
              <h3 className="font-semibold text-purple-900 mb-3">💡 Video Tips:</h3>
              <ul className="space-y-2 text-sm text-purple-800">
                <li>• Keep it around 1 minute - patients appreciate concise introductions</li>
